...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Vercel Hobby corta la función a los 60s totales. Dejamos ~52s para el
    // polling y el resto de margen para descarga/subida a Supabase.
    const maxIntentos = 17;
    const esperaMs = 3000;
